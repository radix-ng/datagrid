...
@Component({
    selector: 'app-view-table-filter',
    template: `
        @if (filterVariant() === 'range') {
            ...
            <input
                ...
                debouncedInput
                [debounce]="500"
                [attr.placeholder]="'Search... (' + column().getFacetedUniqueValues().size + ')'"
...
export class FilterComponent<T> {
    ...
    readonly columnFilterValue = computed<any>(() => this.column().getFilterValue());

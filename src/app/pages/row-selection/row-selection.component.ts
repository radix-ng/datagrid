...
export class RowSelectionComponent {
    ...
    readonly ageHeaderCell = viewChild.required<TemplateRef<unknown>>('ageHeaderCell');
    ...
    readonly stringifiedRowSelection = computed(() => JSON.stringify(this.rowSelection(), null, 2));

    readonly rowSelectionLength = computed(() => Object.keys(this.rowSelection()).length);
